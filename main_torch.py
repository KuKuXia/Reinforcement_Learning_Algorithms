...
from DQN_Torch import Agent, DeepQNetwork
from utils import plotLearning

if __name__ == "__main__":
    env = gym.make('SpaceInvaders-v0')
    brain = Agent(gamma=0.95, epsilon=1.0, alpha=0.003, maxMemorySize=5000,
                  replace=None)
    ...
    while brain.memCounter < brain.memSize:
        ...
        while not done:
            ...
            if done and info['ale.lives'] == 0:
                reward = -100
            brain.storeTransition(np.mean(observation[15:200, 30:125], axis=2), action, reward, np.mean(
                observation[15:200, 30:125], axis=2))
        ...
        for i in range(numGames):
            ...
            while not done:
                ...
                if done and info['ale.lives'] == 0:
                    reward = -100
                brain.storeTransition(np.mean(observation[15:200, 30:125], axis=2), action, reward, np.mean(
                    observation_[15:200, 30:125], axis=2))
